      ...
      <div className = 'row'>
        <div className = 'col'>
          ...
          <p className = 'sub-text'>
            Cats are more adorable and easier to handle when they are little.It is faster for us to pay less money for any other things, but their fur is a little too much every day.</p>
        </div>
        <div className = 'col'>
